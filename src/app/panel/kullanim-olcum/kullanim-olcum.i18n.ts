...
const sozluk: Record<Dil, Record<string, string>> = {
  ...
  de: {
    ...
    "ko.gauge.kullanim": "Kontingentnutzung",
    "ko.gauge.projeksiyon": "Monatsend-Proj.",
    "ko.gauge.donem": "Zeitraumfortschritt",
    "ko.gauge.donemAlt": "Tag {gecen}/{toplam} des Monats",
    "ko.donut.baslik": "Quellenaufschlüsselung (geschätzt)",
    "ko.donut.merkez": "Ereignisse",
    "ko.donut.dogrulama": "Verifizierungsereignisse",
    "ko.donut.apiCagri": "API-Aufrufe",
    "ko.donut.asim": "Überschreitung (prognostiziert)",
    "ko.trend.baslik": "Kumulative Nutzung & Kontingentpfad",
    "ko.trend.aciklama": "Nach Tag des Monats aufgelaufene Verifizierungen; die gestrichelte Linie zeigt den Run-Rate-Pfad zum Kontingent.",
    "ko.trend.gercek": "Kumulativer Istwert",
    "ko.trend.projeksiyon": "Kontingentpfad (Run-Rate)",
    "ko.hist.baslik": "Tägliche Nutzungsverteilung",
    "ko.hist.aciklama": "Das tägliche Verifizierungsvolumen dieses Monats. Der geschäftigste Tag ist hervorgehoben; die durchschnittliche Run-Rate ist die Referenzlinie.",
    "ko.ongoru.baslik": "Prognose",
    "ko.ongoru.tahminiBitis": "Geschätzte Kontingenterschöpfung",
    "ko.ongoru.gunSonra": "an Tag {n}",
    "ko.ongoru.riskYok": "Wird in diesem Zeitraum nicht erschöpft",
    "ko.ongoru.enYogun": "Geschäftigster Tag",
    "ko.ongoru.zirve": "{n} Verifizierungen",
  ...
  fr: {
    ...
    "ko.gauge.kullanim": "Utilisation du quota",
    "ko.gauge.projeksiyon": "Proj. fin de mois",
    "ko.gauge.donem": "Progression de la période",
    "ko.gauge.donemAlt": "Jour {gecen}/{toplam} du mois",
    "ko.donut.baslik": "Répartition par source (estimée)",
    "ko.donut.merkez": "événements",
    "ko.donut.dogrulama": "Événements de vérification",
    "ko.donut.apiCagri": "Appels API",
    "ko.donut.asim": "Dépassement (projeté)",
    "ko.trend.baslik": "Utilisation cumulée & trajectoire du quota",
    "ko.trend.aciklama": "Vérifications accumulées par jour du mois ; la ligne pointillée montre la trajectoire du run-rate vers le quota.",
    "ko.trend.gercek": "Cumul réel",
    "ko.trend.projeksiyon": "Trajectoire du quota (run-rate)",
    "ko.hist.baslik": "Distribution de l'utilisation journalière",
    "ko.hist.aciklama": "Le volume de vérifications journalières de ce mois. Le jour le plus chargé est mis en évidence ; le run-rate moyen est la ligne de référence.",
    "ko.ongoru.baslik": "Prévision",
    "ko.ongoru.tahminiBitis": "Épuisement estimé du quota",
    "ko.ongoru.gunSonra": "le jour {n}",
    "ko.ongoru.riskYok": "Ne s'épuisera pas cette période",
    "ko.ongoru.enYogun": "Jour le plus chargé",
    "ko.ongoru.zirve": "{n} vérifications",
  ...
  es: {
    ...
    "ko.gauge.kullanim": "Uso de cuota",
    "ko.gauge.projeksiyon": "Proy. fin de mes",
    "ko.gauge.donem": "Progreso del período",
    "ko.gauge.donemAlt": "Día {gecen}/{toplam} del mes",
    "ko.donut.baslik": "Desglose por fuente (estimado)",
    "ko.donut.merkez": "eventos",
    "ko.donut.dogrulama": "Eventos de verificación",
    "ko.donut.apiCagri": "Llamadas a la API",
    "ko.donut.asim": "Exceso (proyectado)",
    "ko.trend.baslik": "Uso acumulado y trayectoria de cuota",
    "ko.trend.aciklama": "Verificaciones acumuladas por día del mes; la línea discontinua muestra la trayectoria del run-rate hacia la cuota.",
    "ko.trend.gercek": "Acumulado real",
    "ko.trend.projeksiyon": "Trayectoria de cuota (run-rate)",
    "ko.hist.baslik": "Distribución del uso diario",
    "ko.hist.aciklama": "El volumen de verificaciones diarias de este mes. Se resalta el día más activo; el run-rate promedio es la línea de referencia.",
    "ko.ongoru.baslik": "Pronóstico",
    "ko.ongoru.tahminiBitis": "Agotamiento estimado de la cuota",
    "ko.ongoru.gunSonra": "el día {n}",
    "ko.ongoru.riskYok": "No se agotará este período",
    "ko.ongoru.enYogun": "Día más activo",
    "ko.ongoru.zirve": "{n} verificaciones",
