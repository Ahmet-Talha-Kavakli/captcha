...
const sozluk: Record<Dil, Record<string, string>> = {
  ...
  en: {
    ...
    "gorsel.bolgeDagilim": "Regional distribution",
    "gorsel.bolgeDagilimAlt": "Share of observed events by continent",
    "gorsel.bolgeMerkez": "events",
    "gorsel.isiMatris": "Day × slice risk intensity",
    "gorsel.isiMatrisAlt": "Each cell is the highest country score of that time slice (0-100)",
    "gorsel.asnBaslik": "ASN category distribution",
    "gorsel.asnAlt": "Traffic breakdown by network infrastructure type",
    "gorsel.asnVeriYok": "No ASN to categorize",
    "gorsel.asnHosting": "Hosting / Cloud",
    "gorsel.asnIsp": "ISP / Access",
    "gorsel.asnMobil": "Mobile carrier",
    "gorsel.asnBilinmeyen": "Unknown / Other",
    "gorsel.matrisDilim": "Slice",
  ...
  de: {
    ...
    "gorsel.bolgeDagilim": "Regionale Verteilung",
    "gorsel.bolgeDagilimAlt": "Anteil der beobachteten Ereignisse nach Kontinent",
    "gorsel.bolgeMerkez": "Ereignisse",
    "gorsel.isiMatris": "Risikointensität Tag × Segment",
    "gorsel.isiMatrisAlt": "Jede Zelle ist der höchste Länderwert dieses Zeitsegments (0-100)",
    "gorsel.asnBaslik": "ASN-Kategorieverteilung",
    "gorsel.asnAlt": "Traffic-Aufschlüsselung nach Netzwerkinfrastruktur-Typ",
    "gorsel.asnVeriYok": "Keine ASN zu kategorisieren",
    "gorsel.asnHosting": "Hosting / Cloud",
    "gorsel.asnIsp": "ISP / Zugang",
    "gorsel.asnMobil": "Mobilfunkanbieter",
    "gorsel.asnBilinmeyen": "Unbekannt / Andere",
    "gorsel.matrisDilim": "Segment",
  ...
  fr: {
    ...
    "gorsel.bolgeDagilim": "Répartition régionale",
    "gorsel.bolgeDagilimAlt": "Part des événements observés par continent",
    "gorsel.bolgeMerkez": "événements",
    "gorsel.isiMatris": "Intensité du risque jour × tranche",
    "gorsel.isiMatrisAlt": "Chaque cellule correspond au score de pays le plus élevé de cette tranche horaire (0-100)",
    "gorsel.asnBaslik": "Répartition par catégorie d'ASN",
    "gorsel.asnAlt": "Répartition du trafic par type d'infrastructure réseau",
    "gorsel.asnVeriYok": "Aucun ASN à catégoriser",
    "gorsel.asnHosting": "Hébergement / Cloud",
    "gorsel.asnIsp": "FAI / Accès",
    "gorsel.asnMobil": "Opérateur mobile",
    "gorsel.asnBilinmeyen": "Inconnu / Autre",
    "gorsel.matrisDilim": "Tranche",
  ...
  es: {
    ...
    "gorsel.bolgeDagilim": "Distribución regional",
    "gorsel.bolgeDagilimAlt": "Proporción de eventos observados por continente",
    "gorsel.bolgeMerkez": "eventos",
    "gorsel.isiMatris": "Intensidad de riesgo día × segmento",
    "gorsel.isiMatrisAlt": "Cada celda es la puntuación de país más alta de ese segmento temporal (0-100)",
    "gorsel.asnBaslik": "Distribución por categoría de ASN",
    "gorsel.asnAlt": "Desglose del tráfico por tipo de infraestructura de red",
    "gorsel.asnVeriYok": "No hay ASN que categorizar",
    "gorsel.asnHosting": "Alojamiento / Nube",
    "gorsel.asnIsp": "ISP / Acceso",
    "gorsel.asnMobil": "Operador móvil",
    "gorsel.asnBilinmeyen": "Desconocido / Otro",
    "gorsel.matrisDilim": "Segmento",
