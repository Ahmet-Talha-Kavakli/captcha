...
const sozluk: Record<Dil, Record<string, string>> = {
  ...
  de: {
    ...
    "ka.gorsel.bulguDagilimi": "Verteilung der Funde",
    "ka.gorsel.bulguMerkez": "Treffer",
    "ka.gorsel.kategoriYogunluk": "Kategorie × Schweregrad-Intensität",
    "ka.gorsel.avBasari": "Auslöserate der Jagden",
    "ka.gorsel.avBasariEtiket": "ausgelöst",
    "ka.gorsel.kapsamaProfili": "Abdeckungsprofil",
    "ka.gorsel.tetikDagilimi": "Nähe zur Schwelle",
    "ka.gorsel.kategoriKapsama": "Kategorieabdeckung",
    "ka.gorsel.tetiklenenAv": "ausgelöst",
    "ka.gorsel.toplamEslesme": "Treffer gesamt",
    "ka.gorsel.enAktifKategori": "aktivste Kategorie",
    "ka.gorsel.ortEsik": "Ø Schwelle",
  ...
  fr: {
    ...
    "ka.gorsel.bulguDagilimi": "Distribution des résultats",
    "ka.gorsel.bulguMerkez": "correspondances",
    "ka.gorsel.kategoriYogunluk": "Intensité catégorie × gravité",
    "ka.gorsel.avBasari": "Taux de déclenchement des chasses",
    "ka.gorsel.avBasariEtiket": "déclenchées",
    "ka.gorsel.kapsamaProfili": "Profil de couverture",
    "ka.gorsel.tetikDagilimi": "Proximité du seuil",
    "ka.gorsel.kategoriKapsama": "Couverture par catégorie",
    "ka.gorsel.tetiklenenAv": "déclenchées",
    "ka.gorsel.toplamEslesme": "correspondances au total",
    "ka.gorsel.enAktifKategori": "catégorie la plus active",
    "ka.gorsel.ortEsik": "seuil moy.",
  ...
  es: {
    ...
    "ka.gorsel.bulguDagilimi": "Distribución de hallazgos",
    "ka.gorsel.bulguMerkez": "coincidencias",
    "ka.gorsel.kategoriYogunluk": "Intensidad categoría × gravedad",
    "ka.gorsel.avBasari": "Tasa de disparo de cazas",
    "ka.gorsel.avBasariEtiket": "disparadas",
    "ka.gorsel.kapsamaProfili": "Perfil de cobertura",
    "ka.gorsel.tetikDagilimi": "Proximidad al umbral",
    "ka.gorsel.kategoriKapsama": "Cobertura por categoría",
    "ka.gorsel.tetiklenenAv": "disparadas",
    "ka.gorsel.toplamEslesme": "coincidencias totales",
    "ka.gorsel.enAktifKategori": "categoría más activa",
    "ka.gorsel.ortEsik": "umbral medio",
