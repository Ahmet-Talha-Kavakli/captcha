...
export const POPS: Pop[] = [
  ...
  { kod: "YYZ", sehir: "Toronto", ulke: "CA", bolge: "kuzey-amerika", durum: "bakim", gecikme: 14, p50: 14, p95: 31, p99: 58, trafikPay: 3.1, kapasite: 22, rps: 5000, lat: 43.68, lon: -79.63, omurga: "TorIX / Cologix" },

  // --- Asya-Pasifik ---
  { kod: "SIN", sehir: "Singapur", ulke: "SG", bolge: "asya", durum: "saglikli", gecikme: 9, p50: 9, p95: 26, p99: 48, trafikPay: 6.9, kapasite: 64, rps: 11100, lat: 1.35, lon: 103.99, omurga: "SGIX / Equinix SG" },
  { kod: "NRT", sehir: "Tokyo", ulke: "JP", bolge: "asya", durum: "saglikli", gecikme: 10, p50: 10, p95: 28, p99: 51, trafikPay: 5.8, kapasite: 60, rps: 9400, lat: 35.55, lon: 140.39, omurga: "JPNAP / Equinix TY" },
  ...
  // --- Okyanusya ---
  { kod: "SYD", sehir: "Sydney", ulke: "AU", bolge: "okyanusya", durum: "saglikli", gecikme: 12, p50: 12, p95: 33, p99: 61, trafikPay: 2.6, kapasite: 48, rps: 4200, lat: -33.87, lon: 151.21, omurga: "IX Australia / NextDC" },

  // --- Afrika / Orta Doğu ---
  { kod: "DXB", sehir: "Dubai", ulke: "AE", bolge: "afrika", durum: "saglikli", gecikme: 13, p50: 13, p95: 36, p99: 68, trafikPay: 2.4, kapasite: 44, rps: 3900, lat: 25.25, lon: 55.36, omurga: "UAE-IX / Equinix DX" },
  { kod: "JNB", sehir: "Johannesburg", ulke: "ZA", bolge: "afrika", durum: "dejenere", gecikme: 18, p50: 18, p95: 52, p99: 104, trafikPay: 1.9, kapasite: 76, rps: 3100, lat: -26.13, lon: 28.24, omurga: "NAPAfrica / Teraco" },
];
