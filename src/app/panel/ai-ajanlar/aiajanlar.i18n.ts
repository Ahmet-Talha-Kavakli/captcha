...
const sozluk: Record<Dil, Record<string, string>> = {
  tr: {
    ...
    // Zaman serisi
    "ai.sablon.baslik": "Hızlı politika profilleri",
    "ai.sablon.aciklama": "Tek tıkla tüm AI ajanlarına akıllı, kategori-bazlı politika uygula. Robots.txt ve enforcement anında güncellenir.",
    "ai.sablon.uygulandi": "{n} ajana uygulandı",
    "ai.sablon.hata": "Şablon uygulanamadı",
    "ai.sablon.siki.ad": "Sıkı koru",
    "ai.sablon.siki.desc": "İçeriğini AI eğitiminden ve kazımadan tamamen koru. Canlı getirmeyi doğrula.",
    "ai.sablon.dengeli.ad": "Dengeli (önerilen)",
    "ai.sablon.dengeli.desc": "Veylify'ın her ajan için önerdiği akıllı varsayılan. Koruma + görünürlük dengesi.",
    "ai.sablon.acik.ad": "Açık / AI görünürlüğü",
    "ai.sablon.acik.desc": "Tüm AI ajanlarına izin ver — AI arama ve asistanlarında maksimum görünürlük.",
    "ai.sablon.sadece_arama.ad": "Yalnız arama & asistan",
    "ai.sablon.sadece_arama.desc": "Arama ve canlı getirmeye izin; model eğitimi ve kazımayı engelle.",
    "ai.sablon.sadece_engelle.ad": "Hepsini engelle",
    "ai.sablon.sadece_engelle.desc": "İstisnasız tüm AI ajanlarını engelle. En katı duruş.",
  ...
  en: {
    ...
    "ai.sablon.baslik": "Quick policy profiles",
    "ai.sablon.aciklama": "Apply smart category-based policy to all AI agents in one click. robots.txt and enforcement update instantly.",
    "ai.sablon.uygulandi": "Applied to {n} agents",
    "ai.sablon.hata": "Failed to apply template",
    "ai.sablon.siki.ad": "Strict protect",
    "ai.sablon.siki.desc": "Fully protect content from AI training and scraping. Verify live fetch.",
    "ai.sablon.dengeli.ad": "Balanced (recommended)",
    "ai.sablon.dengeli.desc": "Veylify's smart default per agent. Balances protection and visibility.",
    "ai.sablon.acik.ad": "Open / AI visibility",
    "ai.sablon.acik.desc": "Allow all AI agents — maximum visibility in AI search and assistants.",
    "ai.sablon.sadece_arama.ad": "Search & assistant only",
    "ai.sablon.sadece_arama.desc": "Allow search and live fetch; block model training and scraping.",
    "ai.sablon.sadece_engelle.ad": "Block all",
    "ai.sablon.sadece_engelle.desc": "Block every AI agent without exception. The strictest stance.",
  ...
  de: {
    ...
    "ai.sablon.baslik": "Schnelle Richtlinienprofile",
    "ai.sablon.aciklama": "Wenden Sie mit einem Klick eine intelligente Richtlinie auf alle KI-Agenten an.",
    "ai.sablon.uygulandi": "Auf {n} Agenten angewendet",
    "ai.sablon.hata": "Vorlage konnte nicht angewendet werden",
    "ai.sablon.siki.ad": "Streng schützen",
    "ai.sablon.siki.desc": "Inhalte vollständig vor KI-Training und Scraping schützen.",
    "ai.sablon.dengeli.ad": "Ausgewogen (empfohlen)",
    "ai.sablon.dengeli.desc": "Veylifys intelligente Standardeinstellung pro Agent.",
    "ai.sablon.acik.ad": "Offen / KI-Sichtbarkeit",
    "ai.sablon.acik.desc": "Allen KI-Agenten erlauben — maximale Sichtbarkeit.",
    "ai.sablon.sadece_arama.ad": "Nur Suche & Assistent",
    "ai.sablon.sadece_arama.desc": "Suche und Live-Abruf erlauben; Training und Scraping blockieren.",
    "ai.sablon.sadece_engelle.ad": "Alle blockieren",
    "ai.sablon.sadece_engelle.desc": "Jeden KI-Agenten ausnahmslos blockieren.",
  ...
  fr: {
    ...
    "ai.sablon.baslik": "Profils de politique rapides",
    "ai.sablon.aciklama": "Appliquez une politique intelligente à tous les agents IA en un clic.",
    "ai.sablon.uygulandi": "Appliqué à {n} agents",
    "ai.sablon.hata": "Échec de l'application du modèle",
    "ai.sablon.siki.ad": "Protection stricte",
    "ai.sablon.siki.desc": "Protégez entièrement le contenu de l'entraînement IA et du scraping.",
    "ai.sablon.dengeli.ad": "Équilibré (recommandé)",
    "ai.sablon.dengeli.desc": "Le défaut intelligent de Veylify par agent.",
    "ai.sablon.acik.ad": "Ouvert / Visibilité IA",
    "ai.sablon.acik.desc": "Autoriser tous les agents IA — visibilité maximale.",
    "ai.sablon.sadece_arama.ad": "Recherche & assistant",
    "ai.sablon.sadece_arama.desc": "Autoriser recherche et récupération; bloquer entraînement et scraping.",
    "ai.sablon.sadece_engelle.ad": "Tout bloquer",
    "ai.sablon.sadece_engelle.desc": "Bloquer chaque agent IA sans exception.",
  ...
  es: {
    ...
    "ai.sablon.baslik": "Perfiles de política rápidos",
    "ai.sablon.aciklama": "Aplica una política inteligente a todos los agentes de IA con un clic.",
    "ai.sablon.uygulandi": "Aplicado a {n} agentes",
    "ai.sablon.hata": "Error al aplicar la plantilla",
    "ai.sablon.siki.ad": "Protección estricta",
    "ai.sablon.siki.desc": "Protege el contenido del entrenamiento de IA y el scraping.",
    "ai.sablon.dengeli.ad": "Equilibrado (recomendado)",
    "ai.sablon.dengeli.desc": "El valor predeterminado inteligente de Veylify por agente.",
    "ai.sablon.acik.ad": "Abierto / Visibilidad IA",
    "ai.sablon.acik.desc": "Permitir todos los agentes de IA — máxima visibilidad.",
    "ai.sablon.sadece_arama.ad": "Solo búsqueda y asistente",
    "ai.sablon.sadece_arama.desc": "Permitir búsqueda y recuperación; bloquear entrenamiento y scraping.",
    "ai.sablon.sadece_engelle.ad": "Bloquear todo",
    "ai.sablon.sadece_engelle.desc": "Bloquear cada agente de IA sin excepción.",
