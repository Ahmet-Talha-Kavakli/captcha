...
const sozluk: Record<Dil, Record<string, string>> = {
  ...
  de: {
    ...
    "panorama.filoBaslik": "Flottenkapazität",
    "panorama.kullanim": "Auslastung",
    "panorama.ongoruKullanim": "Prognostizierte Auslastung",
    "panorama.ortHeadroom": "Headroom nach Empfehlung",
    "panorama.zirveBaslik": "Traffic-Spitzentrend",
    "panorama.kapasiteTavani": "Kapazitätsobergrenze",
    "panorama.simdi": "jetzt",
    "panorama.tavan": "Obergrenze",
    "panorama.dagilimBaslik": "Ressourcenauslastung nach Region",
    "panorama.rahat": "entspannt",
    "panorama.normal": "normal",
    "panorama.baskilanan": "überlastet",
    "panorama.dagilimNot": "Jeder Balken zeigt die prognostizierte Last im Verhältnis zur Kapazität dieser Region. Rote Balken überschreiten das Ziel-Headroom-Band (überlastet); grüne Balken sind überbereitgestellt (Sparpotenzial).",
    "takvim.zamanCizgisi": "Rollout-Reihenfolge",
  },
  ...
  fr: {
    ...
    "panorama.filoBaslik": "Capacité de la flotte",
    "panorama.kullanim": "utilisation",
    "panorama.ongoruKullanim": "Utilisation projetée",
    "panorama.ortHeadroom": "Headroom après recommandation",
    "panorama.zirveBaslik": "Tendance des pics de trafic",
    "panorama.kapasiteTavani": "plafond de capacité",
    "panorama.simdi": "maintenant",
    "panorama.tavan": "Plafond",
    "panorama.dagilimBaslik": "Utilisation des ressources par région",
    "panorama.rahat": "détendu",
    "panorama.normal": "normal",
    "panorama.baskilanan": "sous tension",
    "panorama.dagilimNot": "Chaque barre montre la charge projetée par rapport à la capacité de cette région. Les barres rouges dépassent la bande de headroom cible (sous tension) ; les barres vertes sont surprovisionnées (opportunité d'économies).",
    "takvim.zamanCizgisi": "Ordre de déploiement",
  },
  ...
  es: {
    ...
    "panorama.filoBaslik": "Capacidad de la flota",
    "panorama.kullanim": "utilización",
    "panorama.ongoruKullanim": "Utilización proyectada",
    "panorama.ortHeadroom": "Headroom tras recomendación",
    "panorama.zirveBaslik": "Tendencia de picos de tráfico",
    "panorama.kapasiteTavani": "techo de capacidad",
    "panorama.simdi": "ahora",
    "panorama.tavan": "Techo",
    "panorama.dagilimBaslik": "Utilización de recursos por región",
    "panorama.rahat": "holgado",
    "panorama.normal": "normal",
    "panorama.baskilanan": "saturado",
    "panorama.dagilimNot": "Cada barra muestra la carga proyectada en relación con la capacidad de esa región. Las barras rojas superan la banda de headroom objetivo (saturadas); las verdes están sobreaprovisionadas (oportunidad de ahorro).",
    "takvim.zamanCizgisi": "Orden de despliegue",
  },
};
