...
export function GenelBakisIstemci({
  ...
  brifing24, brifing7, brifing30, roi, ekonomi, killZincirler, killOzet, korelasyonlar, korOzet, iliskiGraf,
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-7 px-6 pt-8 pb-16 lg:px-8">
      ...
      {besleme.beslemeler.length > 0 && (
        <motion.div {...bolum((bolumSira++) * 0.06)}>
          <TehditBeslemeBolumu besleme={besleme} azHareket={!!azHareket} />
        </motion.div>
      )}
      ...
      {apiAbuse.endpointler.length > 0 && (
        <motion.div {...bolum((bolumSira++) * 0.06)}>
          <ApiAbuseBolumu rapor={apiAbuse} azHareket={!!azHareket} />
        </motion.div>
      )}
