...
const sozluk: Record<Dil, Record<string, string>> = {
  tr: {
    ...
    "sso.pano.tahminiRozet": "Tahmini",
    "sso.pano.oturumTahminiNot":
      "Bu seri gerçek oturum kaydı yerine aktif üye sayısından türetilmiş bir TAHMİNDİR — IdP bağlanıp oturumlar akmaya başlayınca gerçek verilerle değişir.",
    ...
    "sso.kpi.oturum": "Bugünkü SSO oturumu (tahmini)",
  ...
  en: {
    ...
    "sso.pano.tahminiRozet": "Estimated",
    "sso.pano.oturumTahminiNot":
      "This series is an ESTIMATE derived from your active member count, not real session records — it switches to actual data once your IdP is connected and sessions start flowing.",
    ...
    "sso.kpi.oturum": "SSO sessions today (estimated)",
  ...
  de: {
    ...
    "sso.pano.tahminiRozet": "Geschätzt",
    "sso.pano.oturumTahminiNot":
      "Diese Reihe ist eine SCHÄTZUNG auf Basis Ihrer aktiven Mitgliederzahl, keine echten Sitzungsdaten — sie wird durch echte Daten ersetzt, sobald Ihr IdP verbunden ist und Sitzungen eingehen.",
    ...
    "sso.kpi.oturum": "SSO-Sitzungen heute (geschätzt)",
  ...
  fr: {
    ...
    "sso.pano.tahminiRozet": "Estimé",
    "sso.pano.oturumTahminiNot":
      "Cette série est une ESTIMATION dérivée de votre nombre de membres actifs, et non des enregistrements de sessions réels — elle bascule vers les données réelles une fois votre IdP connecté et les sessions actives.",
    ...
    "sso.kpi.oturum": "Sessions SSO aujourd'hui (estimé)",
  ...
  es: {
    ...
    "sso.pano.tahminiRozet": "Estimado",
    "sso.pano.oturumTahminiNot":
      "Esta serie es una ESTIMACIÓN derivada de tu número de miembros activos, no de registros de sesión reales — cambia a datos reales una vez que tu IdP esté conectado y las sesiones comiencen a fluir.",
    ...
    "sso.kpi.oturum": "Sesiones SSO hoy (estimado)",
