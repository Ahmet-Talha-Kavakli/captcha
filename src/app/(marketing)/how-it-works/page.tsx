  ...
  return (
    <section className="relative overflow-hidden px-5 pt-16 pb-16 lg:px-8 lg:pt-24">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <Reveal delay={2}>
          <Gorsel ad="nasil-hero" alt="Veylify nasıl çalışır" oran="16/10" className="mx-auto mt-8 w-full max-w-md" />
        </Reveal>
        <Reveal delay={3}>
    ...
    <section className="border-y border-veylify-100 bg-veylify-50/30 px-5 py-20 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <Reveal delay={1} className="mt-10">
          <Gorsel ad="nasil-edge" alt="Edge mimarisi" oran="1/1" className="mx-auto w-full max-w-xs" />
        </Reveal>
    ...
    <section className="border-y border-veylify-100 bg-veylify-50/30 px-5 py-20 lg:px-8">
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
        <Reveal>
          ...
          <Gorsel ad="nasil-api" alt="API entegrasyonu" oran="1/1" className="mt-8 w-full max-w-[320px]" />
        </Reveal>
        <Reveal delay={1}>
