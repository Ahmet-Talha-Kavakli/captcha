...
import { GhostFontGorsel, IzgaraArka, Gorsel } from "@/components/site/gorseller";
  ...
  return (
    <section className="relative overflow-hidden px-5 pt-16 pb-16 lg:px-8 lg:pt-24">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <Reveal delay={2}>
          <Gorsel ad="ozellikler-hero" alt="Veylify savunma ekibi" oran="16/9" className="mx-auto mt-8 w-full max-w-xl" />
        </Reveal>
        <Reveal delay={3}>
    ...
    <OzellikBolum
      ...
      gorsel={
        <div className="space-y-6">
          <Gorsel ad="ozellik-cografi" alt="Coğrafi ve ASN istihbaratı" oran="1/1" className="mx-auto w-full max-w-xs" />
          <AkisDiyagram />
        </div>
      }
    />
...
function TlsBolum() {
  return (
    <OzellikBolum
      ...
      gorsel={
        <div className="overflow-hidden rounded-3xl border border-veylify-100 bg-white shadow-[0_24px_64px_-32px_rgba(79,70,229,0.3)]">
          {/* görsel alanı krem → clay görselin zemini ile dikişsiz */}
          <div className="bg-[#f4f1ea] px-6 pt-6">
            <Gorsel ad="ozellik-tls" alt="TLS parmak izi" oran="1/1" className="mx-auto w-44" />
          </div>
          <div className="p-6">
          <div className="mb-4 flex items-center gap-2 text-[13px] font-semibold text-veylify-950">
