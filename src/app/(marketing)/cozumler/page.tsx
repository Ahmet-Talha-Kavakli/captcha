...
import { KalkanSahne, VuruStat, OzellikIzgara } from "@/components/site/illustrasyonlar";
...
function Senaryo({
  ikon: Ikon, etiket, baslik, vurgu, problem, cozumler, metrikler, sagda = false,
}: {
